        ...
        <div class="formHalfs">
            ...
            <div class="formHalf">
                ...
                <select name="school" id="school">
                    ...
                    <option value="Rīgas Valsts 2.ģimnāzija" {{ Auth::user()->school == 'Rīgas Valsts 2.ģimnāzija' ? 'selected' : '' }}>Rīgas Valsts 2. ģimnāzija</option>
                    <option value="Rīgas Valsts 3.ģimnāzija" {{ Auth::user()->school == 'Rīgas Valsts 3.ģimnāzija' ? 'selected' : '' }}>Rīgas Valsts 3. ģimnāzija</option>
                    <option value="Āgenskalna Valsts ģimnāzija" {{ Auth::user()->school == 'Āgenskalna Valsts ģimnāzija' ? 'selected' : '' }}>Āgenskalna Valsts ģimnāzija</option>
                </select><br>
